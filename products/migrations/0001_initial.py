# Generated by Django 4.2.1 on 2023-05-27 21:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_created=True)),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('product_measure', models.CharField(choices=[('Kg', 'Kg'), ('Ml', 'Ml'), ('L', 'L'), (None, None)], max_length=40, null=True)),
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='metaInfo', to='products.product')),
            ],
            options={
                'abstract': False,
            },
